...
// export default function PacketBroker({ runStep, autoRun, resetAll }) {
//   return (
//     <div className="text-gray-100 font-sans min-h-screen relative overflow-x-hidden pb-12 tracking-wide bg-[#05030a]">
//       {/* Background Blobs */}
//       <div className="absolute top-[-10%] left-[-10%] w-[50vw] h-[50vw] bg-purple-950/20 rounded-full blur-[140px] pointer-events-none"></div>
//       <div className="absolute bottom-[10%] right-[-10%] w-[40vw] h-[40vw] bg-indigo-950/20 rounded-full blur-[140px] pointer-events-none"></div>
...
//           <h1 className="font-mono text-4xl lg:text-5xl font-black text-white tracking-tight leading-none mb-3 uppercase">
//             Network Packet
//             <br />
...
//             <div className="bg-[#0f0c1b]/95 border-2 border-purple-900/50 rounded-xl p-5 flex flex-wrap gap-4 shadow-xl glow-purple">
//               <button
//                 onClick={runStep}
//                 className="flex-1 min-w-[160px] bg-purple-600 hover:bg-purple-700 active:scale-95 text-white font-black text-sm py-3.5 px-5 rounded-lg transition duration-150 flex items-center justify-center gap-2 shadow-lg shadow-purple-600/30 uppercase tracking-wider"
//               >
//                 <span>▶</span> Process Next Node
//               </button>
//               <button
//                 onClick={autoRun}
//                 className="flex-1 min-w-[160px] bg-amber-500/10 hover:bg-amber-500/20 border-2 border-amber-500/50 text-amber-400 font-black text-sm py-3.5 px-5 rounded-lg transition duration-150 active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider"
//               >
//                 <span>⚡</span> Auto Run Engine
//               </button>
//             </div>
//           </div>
//         </div>
...
// }
// {
//   /* --- Part 2: Inject Controls & Visualization --- */
// }
// <div className="lg:col-span-7 space-y-6">
//   {/* Flush Core Button */}
//   <button
//     onClick={resetAll}
//     className="bg-rose-950/60 hover:bg-rose-900/60 border-2 border-rose-500/40 text-rose-400 text-xs font-bold py-3.5 px-4 rounded-lg transition duration-150 active:scale-95 flex items-center justify-center gap-2 uppercase tracking-wider"
//   >
...
//         <input
//           type="text"
//           className="w-full h-11 bg-[#161229] border-2 border-purple-900/50 rounded-lg px-3 text-sm text-white font-bold outline-none focus:border-purple-500 transition font-metric font-bold"
//         />
//       </div>
...
//           Priority Tier
//         </label>
//         <select className="w-full h-11 bg-[#161229] border-2 border-purple-900/50 rounded-lg px-2 text-xs text-white font-bold outline-none focus:border-purple-500 transition uppercase tracking-wide">
...
//       className="w-full mt-5 bg-purple-600/20 hover:bg-purple-600/30 border-2 border-purple-500/50 text-purple-200 text-xs font-black py-3 rounded-lg transition duration-150 active:scale-[0.99] uppercase tracking-widest"
//     >
...
//       <span className="font-metric text-sm text-white font-extrabold bg-purple-950 px-2.5 py-0.5 rounded border border-purple-900">
//         0 / 100 MB
//       </span>
//     </div>
//     <div className="w-full h-4 bg-[#161229] border border-purple-900/30 rounded-full overflow-hidden p-0.5">
//       <div className="h-full w-[30%] bg-gradient-to-r from-purple-500 via-indigo-500 to-purple-600 rounded-full transition-all duration-300"></div>
//     </div>
//   </div>
// </div>;

// {
//   /* --- Part 3: Visualization Side (Right) --- */
// }
...
//       </div>
//     </div>
//     <div className="flex flex-wrap gap-2.5 p-4 bg-[#08060f] border-2 border-purple-900/30 rounded-lg min-h-[70px] items-center font-metric font-bold">
//       {/* Yahan heap nodes map karna */}
//     </div>
//   </div>
...
//       </div>
//     </div>
//     <div className="space-y-2.5 max-h-72 overflow-y-auto pr-1 custom-scroll font-metric font-bold">
//       {/* Yahan queue items map karna */}
//     </div>
//   </div>
// </div>;
  ...
  return (
    ...
    >
      ...
      <footer className="max-w-7xl mx-auto px-6 mt-14 pt-6 border-t border-purple-900/30 text-center text-xs text-gray-500 font-mono font-bold tracking-wider uppercase relative z-10">
        System Core Pipeline · Pure DSA Architecture Engine Execution
      </footer>
    </div>
  );
}
